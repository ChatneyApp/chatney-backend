...
func (repo *ChannelRepo) FindByID(channelID bson.ObjectID) (*Channel, error) {
	var channel Channel
...
func (repo *ChannelRepo) CreateChannel(channel Channel) (*Channel, error) {
	channel.Id = bson.NewObjectID() // Generate new ObjectID
...
func (repo *ChannelRepo) DeleteChannel(channelID bson.ObjectID) error {
...
func (repo *ChannelRepo) UpdateChannel(channelID bson.ObjectID, updatedChannel Channel) (*Channel, error) {
	filter := bson.M{"_id": channelID}
